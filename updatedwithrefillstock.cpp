    ...
    while(choice!=4)
    {
        ...
        switch (choice)
        {
            ...
            case 2:
            {
                ...
                cout<<"Enter item ID you want to restock and quantity by which you want to restock\nWhen done please enter -1.\n\n";
                ...
                int itemCode=0,restockQuantity=0;
                    while(true)
                    {
                        ...
                        else
                        {
                            ...
                            int confirm=-2;
                            cout << "Please confirm the restocking. Enter 1 to confirm, 0 to cancel your request." << endl;
                            cin >> confirm;
                            if(confirm==-1)
                            return 0;
                            else if(confirm==0)
